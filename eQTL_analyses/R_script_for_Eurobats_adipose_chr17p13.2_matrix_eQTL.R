...
jpeg("Eurobats_adipose_chr17p13.2_eQTLs_from_INT_logTPM_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_chr17p13.2_cis-eQTLs_from_INT_logTPM.txt",sep="\t",quote = FALSE,row.names=FALSE)
