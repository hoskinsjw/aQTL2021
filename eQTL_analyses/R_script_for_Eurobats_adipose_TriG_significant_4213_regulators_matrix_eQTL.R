...
jpeg("Eurobats_adipose_TriG_sig_eQTLs_from_INT_logTPM_of_4213_regulators_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_TriG_sig_cis-eQTLs_from_INT_logTPM_of_4213_regulators.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_TriG_sig_trans-eQTLs_from_INT_logTPM_of_4213_regulators.txt",sep="\t",quote = FALSE,row.names=FALSE)
