...
expression_file_name = "../../Adipose\ expression\ data/FINAL_logTPMs_and_activities/Filtered_Eurobats_adipose_qnorm_INT_logTPMs_for_TriG_RF_MRs.txt";
...
jpeg("Eurobats_adipose_TriG_sig_eQTLs_from_INT_logTPM_of_TriG_RF_MRs_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_TriG_sig_cis-eQTLs_from_INT_logTPM_of_TriG_RF_MRs.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_TriG_sig_trans-eQTLs_from_INT_logTPM_of_TriG_RF_MRs.txt",sep="\t",quote = FALSE,row.names=FALSE)
