...
expression_file_name = "../../Adipose\ expression\ data/FINAL_logTPMs_and_activities/Filtered_Eurobats_adipose_unnormalized_activities_from_logTPM_for_HDL_RF_MRs.txt";
...
jpeg("Eurobats_adipose_HDL_sig_aQTLs_from_unnormalized_activities_of_HDL_RF_MRs_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_HDL_sig_cis-aQTLs_from_unnormalized_activities_of_HDL_RF_MRs.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_HDL_sig_trans-aQTLs_from_unnormalized_activities_of_HDL_RF_MRs.txt",sep="\t",quote = FALSE,row.names=FALSE)
