...
jpeg("Eurobats_adipose_WHRadjBMI_sig_aQTLs_from_unnormalized_activities_of_4213_regulators_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_WHRadjBMI_sig_cis-aQTLs_from_unnormalized_activities_of_4213_regulators.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_WHRadjBMI_sig_trans-aQTLs_from_unnormalized_activities_of_4213_regulators.txt",sep="\t",quote = FALSE,row.names=FALSE)
