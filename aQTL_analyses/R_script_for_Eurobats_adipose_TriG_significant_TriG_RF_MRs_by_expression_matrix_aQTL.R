...
# Genotype file name
SNP_file_name = "../TriG_significant_SNPs_QCd_filtered.dosage";
snps_location_file_name = "../TriG_significant_SNPs_locations_QCd.txt";

# Gene expression file name
expression_file_name = "../../Adipose\ expression\ data/FINAL_logTPMs_and_activities/Filtered_Eurobats_adipose_unnormalized_activities_from_logTPM_for_TriG_RF_MRs_by_expression.txt";
...
jpeg("Eurobats_adipose_TriG_sig_aQTLs_from_unnormalized_activities_of_TriG_RF_MRs_by_expression_plot.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_TriG_sig_cis-aQTLs_from_unnormalized_activities_of_TriG_RF_MRs_by_expression.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_TriG_sig_trans-aQTLs_from_unnormalized_activities_of_TriG_RF_MRs_by_expression.txt",sep="\t",quote = FALSE,row.names=FALSE)
