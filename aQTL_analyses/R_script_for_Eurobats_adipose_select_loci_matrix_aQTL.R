...
jpeg("Eurobats_adipose_select_loci_aQTLs_from_unnormalized_activities.jpg")
plot(me)
dev.off()

write.table(cis_eqtls,"Eurobats_adipose_select_loci_cis-aQTLs_from_unnormalized_activities.txt",sep="\t",quote = FALSE,row.names=FALSE)
write.table(trans_eqtls,"Eurobats_adipose_select_loci_trans-aQTLs_from_unnormalized_activities.txt",sep="\t",quote = FALSE,row.names=FALSE)
